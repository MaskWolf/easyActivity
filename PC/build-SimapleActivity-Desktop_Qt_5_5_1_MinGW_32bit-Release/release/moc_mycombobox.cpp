...
#include "../../SimapleActivity/mycombobox.h"
...
QT_MOC_LITERAL(3, 26, 9) // "is_normal"
    ...
    "MyComboBox\0changeBkColor\0\0is_normal"
};
...
void MyComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyComboBox::changeBkColor)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyComboBox::changeBkColor(bool _t1)
{
