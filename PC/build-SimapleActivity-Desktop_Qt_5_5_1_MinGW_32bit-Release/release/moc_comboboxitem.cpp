...
#include "../../SimapleActivity/comboboxitem.h"
...
QT_MOC_LITERAL(1, 13, 9), // "clickItem"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 2) // "id"

    },
    "ComboBoxItem\0clickItem\0\0id"
};
...
void ComboBoxItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickItem((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ComboBoxItem::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ComboBoxItem::clickItem)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ComboBoxItem::clickItem(QString _t1)
{
