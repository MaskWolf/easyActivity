...
#include "../../SimapleActivity/getimage.h"
...
QT_MOC_LITERAL(1, 9, 2), // "ok"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 6) // "not_ok"

    },
    "GetImage\0ok\0\0not_ok"
};
...
void GetImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GetImage::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GetImage::ok)) {
                *result = 0;
            }
        }
        {
            typedef void (GetImage::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GetImage::not_ok)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject GetImage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GetImage.data,
