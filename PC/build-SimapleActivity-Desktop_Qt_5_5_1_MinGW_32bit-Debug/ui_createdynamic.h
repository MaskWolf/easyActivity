...
public:
    ...
    void setupUi(QWidget *CreateDynamic)
    {
        ...
        toolButton_add_image->setMinimumSize(QSize(35, 30));
        toolButton_add_image->setMaximumSize(QSize(35, 30));
        QIcon icon;
        icon.addFile(QStringLiteral(":/Main/C:/Users/ASUS/Pictures/Camera Roll/fap.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_add_image->setIcon(icon);
        toolButton_add_image->setIconSize(QSize(35, 30));
