...
#include "../../SimapleActivity/mylineedit.h"
...
QT_MOC_LITERAL(1, 11, 13), // "changeBkColor"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9) // "is_normal"

    },
    "MyLineEdit\0changeBkColor\0\0is_normal"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeBkColor((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyLineEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLineEdit::changeBkColor)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyLineEdit::changeBkColor(bool _t1)
{
