...
#include "../../SimapleActivity/mylabel.h"
...
QT_MOC_LITERAL(1, 8, 13), // "choosedPixmap"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 6) // "pixmap"

    },
    "MyLabel\0choosedPixmap\0\0pixmap"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->choosedPixmap((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::choosedPixmap)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyLabel::choosedPixmap(const QString & _t1)
{
