...
public class TableItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setOnSettingClickListener(View.OnClickListener onSettingClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType ) {
        ...
        ContentViewHolder contentViewHolder = new ContentViewHolder(view,onSettingClickListener);
    ...
    public static class ContentViewHolder extends RecyclerView.ViewHolder{
        ...
        public ContentViewHolder(@NonNull View itemView, View.OnClickListener onSettingClickListener) {
            super(itemView);
            this.onSettingClickListener = onSettingClickListener;
            ...
            ivSetting.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onSettingClickListener.onClick(v);
                }
            });
        }
    }
